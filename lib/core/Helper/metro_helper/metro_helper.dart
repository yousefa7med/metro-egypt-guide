...
List<List<StationModel>> allLines = [
  line1,
  line2,
  line3Main,
  line3Branch1,
...
List<StationModel> line3Branch1 = [
  StationModel(
    lineColor: AppColor.line3Color,
    name: "Sudan",
    latitude: 30.0697,
...
List<StationModel> line3Branch2 = [
  StationModel(
    lineColor: AppColor.line3Color,
    name: "Tawfikia",
    latitude: 30.0653,
...
class Metro {
  ...
  StationModel _getDirection(
    List<StationModel> line,
    String start,
    String end,
  ) {
    int indexS = line.indexWhere((e) => e.name == start);
    int indexF = line.indexWhere((e) => e.name == end);
  ...
  StationModel? _getStation(String name) {
    for (var line in allLines) {
      if (line.any((e) => e.name == name)) {
        return line.firstWhere((e) => e.name == name);
      }
    }
    return null;
  }

  List<StationModel>? _cheackSameLine(
    String firstStation,
    String secondStation,
  ) {
    if ((line3Main.any((e) => e.name == firstStation) &&
            line3Branch1.any((e) => e.name == secondStation)) ||
        (line3Branch1.any((e) => e.name == firstStation) &&
            line3Main.any((e) => e.name == secondStation))) {
      return [...line3Main, ...line3Branch1];
    } else if ((line3Main.any((e) => e.name == firstStation) &&
            line3Branch2.any((e) => e.name == secondStation)) ||
        (line3Branch2.any((e) => e.name == firstStation) &&
            line3Main.any((e) => e.name == secondStation))) {
      return [...line3Main, ...line3Branch2];
    } else if (line3Main.any((e) => e.name == firstStation) &&
        line3Main.any((e) => e.name == secondStation)) {
      return [...line3Main, ...line3Branch1];
    } else if (line3Branch1.any((e) => e.name == firstStation) &&
        line3Branch1.any((e) => e.name == secondStation)) {
      return line3Branch1;
    } else if (line3Branch2.any((e) => e.name == firstStation) &&
        line3Branch2.any((e) => e.name == secondStation)) {
      return line3Branch2;
    } else if (line2.any((e) => e.name == firstStation) &&
        line2.any((e) => e.name == secondStation)) {
      return line2;
    } else if (line1.any((e) => e.name == firstStation) &&
        line1.any((e) => e.name == secondStation)) {
      return line1;
    }
  ...
  List<StationModel> _findShortestPath(
    ...
    for (var line in allLines) {
      if (!line.any((e) => e.name == start)) continue;

      final index = line.indexWhere((e) => e.name == start);
